    ...
    private static void initializeGame() {
        ...
        for (int row = 0; row < 8; row++) {
            for (int low = 0; low < 10; low++) {
                int count = 0;
                if (!landMines[row][low]) {
                    if (row - 1 >= 0 && low - 1 >= 0 && landMines[row - 1][low - 1]) {
                        count++;
                    }
                    if (row - 1 >= 0 && landMines[row - 1][low]) {
                        count++;
                    }
                    if (row - 1 >= 0 && low + 1 < 10 && landMines[row - 1][low + 1]) {
                        count++;
                    }
                    if (low - 1 >= 0 && landMines[row][low - 1]) {
                        count++;
                    }
                    if (low + 1 < 10 && landMines[row][low + 1]) {
                        count++;
                    }
                    if (row + 1 < 8 && low - 1 >= 0 && landMines[row + 1][low - 1]) {
                        count++;
                    }
                    if (row + 1 < 8 && landMines[row + 1][low]) {
                        count++;
                    }
                    if (row + 1 < 8 && low + 1 < 10 && landMines[row + 1][low + 1]) {
                        count++;
                    }
                    landMineCounts[row][low] = count;
                    continue;
                }
                landMineCounts[row][low] = 0;
            }
        }
    }
